        ...
        ZStack(alignment: .leading) {
            VStack {
                ...
                VStack {
                    ...
                    AsyncImage(url: URL(string: "https://cdn.pixabay.com/photo/2016/03/31/21/40/city-1296581_960_720.png")) { image in image
                            .resizable()
            ...
            VStack {
                ...
                .padding()
                .padding(.bottom, 20)
                .foregroundColor(Color(hue: 0.843, saturation: 0.224, brightness: 0.941))
                .background(.white)
